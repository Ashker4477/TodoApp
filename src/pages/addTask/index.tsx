    ...
    return (
        <View style={{ flex: 1, flexDirection: 'column' }}>
            ...
            <View style={styles.pencil}>
                <Image resizeMode='contain' style={styles.dot} source={require("../../assets/images/bluedot/blue_dot.png")} />
                <Image resizeMode='contain' style={styles.img} source={require("../../assets/images/pencil/pencil1.png")} />
            </View>
            <ScrollView style={styles.bg} showsVerticalScrollIndicator>
                ...
                <View style={styles.buttonContainer}>
                    <Button label={index > -1 ? "Edit task" : 'Add task'}
                        onPress={() => {
                            index > -1 ? dispatch(editTask({ index, value }))
                                :
